...
"""
    ...
    while len(cont_order) > 0:
        ...
        #print(type(A_cont), B_cont)
        #print(tensor_list[locs[0]].shape)
        #print(tensor_list[locs[1]].shape)
        #print(type([0]))
        ...
        connect_list.append(np.append(onp.delete(connect_list[locs[0]], A_cont), onp.delete(connect_list[locs[1]], B_cont)))
